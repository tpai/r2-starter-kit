...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appRouter = __webpack_require__(177);

	var _appRouter2 = _interopRequireDefault(_appRouter);

	var _srcStoreTheStore = __webpack_require__(229);

	var _srcStoreTheStore2 = _interopRequireDefault(_srcStoreTheStore);

	__webpack_require__(233);

	var store = (0, _srcStoreTheStore2["default"])();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcComponentsList = __webpack_require__(224);

	var _srcComponentsList2 = _interopRequireDefault(_srcComponentsList);

	var _srcComponentsCtnt = __webpack_require__(228);

	var _srcComponentsCtnt2 = _interopRequireDefault(_srcComponentsCtnt);
		...
		_createClass(AppRouter, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					_reactRouter.Router,
					null,
					_react2["default"].createElement(_reactRouter.Route, { path: "/", component: _srcComponentsList2["default"] }),
					_react2["default"].createElement(_reactRouter.Route, { path: "/content/:id", component: _srcComponentsCtnt2["default"], history: _reactRouter.History })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsActions = __webpack_require__(225);
	...
	var List = (function (_Component) {
		...
		_createClass(List, [{
			...
			value: function componentDidMount() {
				...
				dispatch((0, _actionsActions.fetchList)());
			}
		}, {
			key: "render",
			value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RECEIVE_LIST = RECEIVE_LIST;
	...
	function fetchPost(id) {
		return function (dispatch) {
			return (0, _isomorphicFetch2["default"])("http://jsonplaceholder.typicode.com/posts/" + id).then(function (response) {
	...
	function fetchList() {
		return function (dispatch) {
			return (0, _isomorphicFetch2["default"])("http://jsonplaceholder.typicode.com/posts").then(function (response) {
				return response.json();
			}).then(function (json) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ctnt = (function (_Component) {
		_inherits(Ctnt, _Component);

		function Ctnt(props) {
			_classCallCheck(this, Ctnt);

			_get(Object.getPrototypeOf(Ctnt.prototype), "constructor", this).call(this, props);
		...
		_createClass(Ctnt, [{
			...
			value: function componentWillReceiveProps(nextProps) {
				...
				if (nextProps.detail.nowPage !== detail.nowPage) {
					dispatch((0, _actionsActions.fetchPost)(nextProps.detail.nowPage));
			...
			value: function componentDidMount() {
				...
				dispatch((0, _actionsActions.fetchPost)(params.id));
				dispatch((0, _actionsActions.setPage)(params.id));
			}
		}, {
			key: "handleNextPage",
			value: function handleNextPage() {
				...
				var detail = _props3.detail;

				dispatch((0, _actionsActions.nextPage)(detail.nowPage));
			}
		}, {
			key: "handlePrevPage",
			value: function handlePrevPage() {
				...
				var detail = _props4.detail;

				dispatch((0, _actionsActions.prevPage)(detail.nowPage));
			}
		}, {
			key: "render",
			value: function render() {
	...
	exports["default"] = (0, _reactRedux.connect)(mapStateToProps)(Ctnt);
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function theStore(initialState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.nowPage = nowPage;
	exports.post = post;
	exports.list = list;

	var _actionsActions = __webpack_require__(225);

	function nowPage(state, action) {
		if (state === undefined) state = 1;

		switch (action.type) {
			case _actionsActions.SET_PAGE:
	...
	function post(state, action) {
		...
		switch (action.type) {
			case _actionsActions.RECEIVE_POST:
	...
	function list(state, action) {
		...
		switch (action.type) {
			case _actionsActions.RECEIVE_LIST:
				return action.list;
			default:
				return state;
		}
